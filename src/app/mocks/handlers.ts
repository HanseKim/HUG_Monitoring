...
const SEED_CONTRACTS: MonitorContract[] = [
  {
    ...
    houseType: "다세대주택",
    before: { grade: "안심", riskPct: 2.4, jeonseRatio: 74, seniorRatio: 0, snapshotAt: "2026-06-05" },
    after: { grade: "위험", riskPct: 41.8, jeonseRatio: 97, seniorRatio: 20.4, snapshotAt: "2026-07-22" },
    trigger: "T3_등기변동",
    reason: "선순위채권 8천만원 신규 설정(선순위비율 0% → 20.4%) · 매매지수 하락으로 adj_전세가율 상승",
    recommendations: [],
  },
  {
    ...
    houseType: "다세대주택",
    before: { grade: "안심", riskPct: 8.2, jeonseRatio: 78, seniorRatio: 0, snapshotAt: "2026-06-01" },
    after: { grade: "위험", riskPct: 46.2, jeonseRatio: 95, seniorRatio: 33.4, snapshotAt: "2026-07-12" },
    trigger: "T3_등기변동",
    reason: "선순위채권 1.2억원 신규 설정 — 선순위비율 0% → 33.4%",
    recommendations: [],
  },
  {
    ...
    houseType: "오피스텔",
    before: { grade: "주의", riskPct: 12.4, jeonseRatio: 84, seniorRatio: 12.1, snapshotAt: "2026-05-15" },
    after: { grade: "위험", riskPct: 38.9, jeonseRatio: 93, seniorRatio: 12.1, snapshotAt: "2026-07-03" },
    trigger: "T1_정기",
    reason: "매매지수 하락 반영 — adj_전세가율 84% → 93%",
    recommendations: [],
  },
  {
    ...
    trigger: "T4_지역리스크",
    reason: "지역 평균 대비 rel_전세가율 상승 — 경기 지역 전세지수 하락 반영",
    recommendations: [],
  },
  {
    ...
    trigger: "T2_금리",
    reason: "시장지수 소폭 변동 — 등급 변동 없음, 경보만 발령",
    recommendations: [],
  },
  {
